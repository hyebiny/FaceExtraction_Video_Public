...
class MotionAugmentation:
    ...
    def _motion_affine(self, *imgs, varT=None):
    ...
    def _motion_color_jitter(self, *imgs, varT=None):
        ...
        for t in range(T):
            if varT is None:
                ...
                percentage = easing(t / varT) * strength
            # percentage = easing(t / (T - 1)) * strength
            for img in imgs:
    ...
    def _motion_blur(self, *imgs, varT=None):
